...
global.loading = pickRandom([mess.wait, 'Sabakh...', 'Tunggu Sebentar...', 'Tunggu', 'Tahan...']);
...
global.love = '💕'
global.zw = 'ㄊ'
global.sticker_wm = '© Encode —CodeTeam'
global.logo_premium = 'Ⓟ'
global.logo_limit = 'Ⓛ'
global.isPrefix = ['.', ',', '#', '?', '/']
global.wm = `By ${setting.footer}`
global.logo_title = '═┅═┅═[ x ]═┅═┅═'
global.gcbot_short = 'https://codeteam.my.id'
...
global.link_group = 'https://www.youtube.com/@pontajs'
global.group_welcome = '*Selamat Datang*\n*%user* \n*Di %subject*\n*Kenalan dulu yuk*\n*Nama:*\n*Umur:*\n*Asal Kota:*\n*Hoby:*\n*Waifu:*\n'
global.group_bye = '*Selamat tinggal*\n*%user* \n*Has Left The %subject Group*'
